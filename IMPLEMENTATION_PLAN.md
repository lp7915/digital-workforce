...
## Stage 10: 人与事记忆分流
**Goal**: 人物事实写员工 MA Store，项目事件写项目 MA Store。
**Success Criteria**: 服务端固定归属，人物按真实发言者 ID 去重，并保留事实依据。
**Tests**: 双目标路由、来源身份校验、更新冲突和工具升级。
**Status**: Complete

## Stage 11: 整理体验与验收
**Goal**: 更新整理入口和结果分类，验证 MA 工具执行。
**Success Criteria**: 页面说明清晰，真实 MA 写回两类记忆并回读。
**Tests**: 完整回归、构建、真实隔离资源测试。
**Status**: In Progress
